...
const MaleAvatar = ({ size = 32 }: { size?: number }) => (
  <svg
    ...
    viewBox="0 0 324.385 324.385"
    xmlSpace="preserve"
    width={size}
    height={size}
    // width и height можно задать при необходимости, например width={324} height={324}
  >
    <g id="XMLID_1093_">
      <g id="XMLID_1094_">
        <g id="XMLID_1304_">
          <path
            id="XMLID_1305_"
            style={{ fill: '#F3D8B6' }}
            d="M245.381,228.832c-18.667-6.681-51.458-11.736-51.458-81.376h-29.23h-5.002
        ...
        <path
          id="XMLID_1306_"
          style={{ fill: '#EEC8A2' }}
          d="M193.923,147.457h-29.23h-2.417v135.497c1.526,0.472,2.417,0.654,2.417,0.654
      ...
      <g id="XMLID_1307_">
        <g id="XMLID_1308_">
          <path
            id="XMLID_1309_"
            style={{ fill: '#F3DBC4' }}
            d="M162.194,169.619c-27.454,0-48.409-23.119-57.799-40.456
        ...
        <path
          id="XMLID_1310_"
          style={{ fill: '#EDCEAE' }}
          d="M215.653,22.266C196.395-3.867,164.065,7.729,162.276,8.397v161.22
      ...
      <g id="XMLID_1312_">
        <g id="XMLID_1313_">
          <path
            id="XMLID_1314_"
            style={{ fill: '#A7B8D4' }}
            d="M204.186,91.841h-27.689c-1.185,0-2.356,0.243-3.431,0.713l-10.874,3.873
        ...
        <path
          id="XMLID_1315_"
          style={{ fill: '#8AA4C2' }}
          d="M204.186,91.841h-27.689c-1.185,0-2.356,0.243-3.431,0.713l-10.791,3.843v10.529
      ...
      <g id="XMLID_1316_">
        <path
          id="XMLID_1319_"
          style={{ fill: '#A0756F' }}
          d="M218.585,18.112c-2.16,0.019-25.469-13.121-41.382-16.355
      ...
      <g id="XMLID_1325_">
        <g id="XMLID_1326_">
          <path
            id="XMLID_46_"
            style={{ fill: '#367992' }}
            d="M82.285,212.791c6.042-3.641,19.69-7.43,26.844-9.196
          ...
          <path
            id="XMLID_43_"
            style={{ fill: '#358BA2' }}
            d="M123.096,193.924c0,0-32.452,8.501-39.684,18.626
        ...
        <g id="XMLID_1327_">
          <path
            id="XMLID_1332_"
            style={{ fill: '#2F697E' }}
            d="M242.099,212.791c-6.042-3.641-19.69-7.43-26.844-9.196
          ...
          <path
            id="XMLID_1335_"
            style={{ fill: '#367992' }}
            d="M201.289,193.924c0,0,32.452,8.501,39.684,18.626
